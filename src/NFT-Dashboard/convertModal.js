            ...
            <div class="convertModal-style ">
              ...
              <div className="convertModal-amount-flex">
                <div>
                  ...
                  <input
                    className="amount-field-convertModal"
                    type="text"
                    id="amount"
                    placeholder="Amount"
                  />
                ...
                <div>
                  <select className="convertModal-coinSelection">
              ...
              <div>
                <label className="convert-coins-label">You Will Receive:</label>
                <br />
                 {" "}
                <input
                  className="convert-Coins-field"
                  type="text"
                  placeholder="10,000 Coins"
                />
              </div>
