...
const TermsAndConditions = () => {
  ...
  return (
    <>
      <Header />
      <div className="backgroud-terms-conditions">
        ...
        <p>
          ...
          related to it, still belong to Roxo.
        </p>
        <p>
          Roxo is committed to ensuring that the app is as useful and efficient
        ...
        <p>
          The King Haste app stores and processes personal data that you have
          ...
          King Haste app won’t work properly or at all.
        </p>
        <p>
          You should be aware that there are certain things that Roxo will not
          ...
          Wi-Fi, or provided by your mobile network provider, but Roxo cannot
        ...
        <p>
          Along the same lines, Roxo cannot always take responsibility for the
          ...
          the Service, Roxo cannot accept responsibility.
        </p>
        <p>
          With respect to Roxo responsibility for your use of the app, when
          ...
          it available to you. Roxo accepts no liability for any loss, direct or
        ...
        <p>
          ...
          keep using the app. Roxo does not promise that it will always update
        ...
        <p>These terms and conditions are effective as of 2022</p>
        <h3>Contact Us</h3>
        <p>
